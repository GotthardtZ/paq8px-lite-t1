...
static void printHelp() {
  printf("\n"
         ...
         "\n"
         "      -0 = no compression, only transformations when applicable (uses 424 MB)\n"
         "      -1 -2 -3 = compress using less memory (652, 666, 698 MB)\n"
         "      -4 -5 -6 -7 -8 -9 = use more memory (754, 870, 1103, 1569, 2501, 4364 MB)\n"
         "      -10  -11  -12     = use even more memory (8091, 15545, 29428 MB)\n"
         "\n"
